...
approached. Quickly homes 
towards target.
Three Pods, separate.
Blast: Knocks target sideways
slowly, high hitstun."
RoboBytes:
byte[4] |
00, | #Illegal Toggle
...
150, | #Vertical Explosion Trigger Radius
360, | #Fuse Time
...
160, | #Locked On Phase Speed
190, | #Roaming Phase Height
190, | #Locked On Phase Height
