...
half [3] |
15, | #Explosion Expansion Duration
70, | #Explosion Lingering Hitbox Duration
0x0000 #Empty Data?
float [3] |
0.96666664, | #eExplosion Size after Initial Expansion
0.96666664, | #Final Explosion Size
