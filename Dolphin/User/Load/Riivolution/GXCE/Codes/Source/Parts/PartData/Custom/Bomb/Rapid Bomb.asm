...
Can be fired often.
Air: Flies quickly in a low arc.
Can be fired often.
Blast: Small blast, low down, 
knocks opponent diagonally 
upwards."
RoboBytes:
byte [2] |
00, | #Illegal Toggle
1 #Number of Bombs Fired
half [1] 20 #Explosion Trigger Radius
#################
## Ground Shot ##
#################
byte [2] |
...
half [3] |
9, | #Explosion Expansion Radius
32, | #Lingering Hitbox Duration
0x0000 #Empty Data?
float [3] |
