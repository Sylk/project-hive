...
half [38] |
290, 320, 350, | #Reduced, Unmodified, and Boosted Air Dash Speed
...
2, |    #Startup Phase Angle
20, |    #Attack Phase Angle
55, |  #Recovery Phase Angle
0, |   #Hitbox Size Related
0, |   #Hitbox Size Related
0       #Hitbox Size Related
ExtraBytes:
byte [5] 8, 4, 1, 6, 7   #Stat Line
